<label
    ...
    <span class="mt-2 text-base leading-normal">Naloži fotografije</span>
    <input id="img_input" name="images[]" type='file' class="hidden" multiple/>

</label>

<div id="img-holder" class="my-4"></div>
